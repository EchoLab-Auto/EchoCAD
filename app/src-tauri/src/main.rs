...
use commands::{
    ...
    update_entity_prop, delete_entity, delete_entity_no_snapshot, move_feature_under, detach_feature_child, trim_entity, extend_entity, update_parameter, rename_feature,
